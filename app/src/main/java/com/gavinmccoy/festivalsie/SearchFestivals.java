...
//            oslist.add(map);
            ...
            ListAdapter adapter = new SimpleAdapter(SearchFestivals.this, oslist, R.layout.list_item, new String[]{TAG_VENUE_OBJ_DISPLAYNAME, TAG_VENUE_OBJ_ID}, new int[]{R.id.name, R.id.id});
